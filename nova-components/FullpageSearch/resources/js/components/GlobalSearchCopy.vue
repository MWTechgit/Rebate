...
This is copy and pasted from /nova/resources/js/components/GlobalSearch.vue

1) Erase the 'vue-clickaway' mixin import and the directive
so that we dont' have to install an unnecessary package

2) Add the following in the template after the results output:

<p v-if="item.status" class="text-xs text-80 item-status">{{ item.status }}</p>
